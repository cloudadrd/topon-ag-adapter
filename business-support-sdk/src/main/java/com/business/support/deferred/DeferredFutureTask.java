...
import static com.business.support.deferred.DeferredManager.*;
...
public class DeferredFutureTask<D, P> extends FutureTask<D> {
    private static final String TAG = DeferredFutureTask.class.getName();
    ...
    protected void done() {
        ...
        try {
            ...
            Log.w(TAG, "Unexpected error when resolving value", t);
        }
    }
    ...
    protected void cleanup() {
        try {
            ...
            // TODO: forward to global ExceptionHandler
            Log.w(TAG, "Unexpected error when cleaning up", t);
        }
    }
