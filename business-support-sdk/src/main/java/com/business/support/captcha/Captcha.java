...
public class Captcha extends LinearLayout {
    ...
    public Captcha(@NonNull final Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        drawableId = typedArray.getResourceId(R.styleable.Captcha_src, R.drawable.bssdk_cat);
        progressDrawableId = typedArray.getResourceId(R.styleable.Captcha_progressDrawable, R.drawable.bssdk_po_seekbar);
        thumbDrawableId = typedArray.getResourceId(R.styleable.Captcha_thumbDrawable, R.drawable.bssdk_thumb);
    ...
    private void init() {
        View parentView = LayoutInflater.from(getContext()).inflate(R.layout.bssdk_container, this, true);
